...
# Load ALL required packages stored in "requirements.txt"
...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    textInput("since_when", "Enter start date eg. 2019-01-01"),

    # textInput("until_when", "Enter end date eg. 2021-06-10"),
